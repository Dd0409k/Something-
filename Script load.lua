...
notify.New("LITERALLY A COSTUME SCRIPT", 30)
...
local path = "wait(5);loadstring(game:HttpGet('https://raw.githubusercontent.com/acsu123/HohoV2/177727259877ebb6fb6077ea9f64566b701cb3c4/ScriptLoad.lua'))()"
-- if getgenv().Key then
